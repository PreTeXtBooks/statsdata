...
[![R-CMD-check](https://github.com/PreTeXtBooks/statsbooks/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/PreTeXtBooks/statsbooks/actions/workflows/R-CMD-check.yaml)
[![Lifecycle:
stable](https://img.shields.io/badge/lifecycle-stable-brightgreen.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
<!-- badges: end -->

`statsbooks` provides the datasets used in the PreTeXtBooks open
...
pak::pak("IDEMSInternational/statsbooks")
```
...
[`data-raw/`](https://github.com/PreTeXtBooks/statsbooks/tree/main/data-raw)
folder.
